...
a file to ensure the symbols are balanced and that there are none of the specified syntax errors. Specifically, to ensure { }'s, ( )'s, [ ]'s, 
" "'s, and /\* \*/'s are properly balanced, and that each one is part of 
a pair. It doesn't handle single line comments, literals, or the diamond operator.
